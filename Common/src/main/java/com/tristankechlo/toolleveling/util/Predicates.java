...
public final class Predicates {
    ...
    public static final Predicate<ItemStack> BONUS_ITEM_MIN_STRENGTH = (stack) -> ToolLevelingConfig.INSTANCE.getBonusItemMinStrength(stack) != 0;
    public static final Predicate<ItemStack> BONUS_ITEM_STRENGTH = (stack) -> ToolLevelingConfig.INSTANCE.getBonusItemStrength(stack) != 0;
    public static final Predicate<ItemStack> BONUS_ITEM_ITERATIONS = (stack) -> ToolLevelingConfig.INSTANCE.getBonusItemIterations(stack) != 0;
